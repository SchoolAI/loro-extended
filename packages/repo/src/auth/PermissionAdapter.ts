...
export interface PermissionAdapter {
  /**
   * Determines if this repo can include a documentId to a remote peer when the
   * remote peer requests a list of all documents.
   *
   ...
   */
  canList?(peerId: PeerId, documentId: DocumentId): Promise<boolean> | boolean
